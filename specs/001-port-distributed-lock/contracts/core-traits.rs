//! Core trait definitions for distributed-lock-rs
//!
//! This file defines the public API contracts that all backends must implement.
...
pub enum LockError {
    ...
    /// Lock was lost after acquisition.
    LockLost(String),
    /// Invalid lock name provided.
    InvalidName(String),
